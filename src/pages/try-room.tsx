...
export function TryRoom() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("height", height.toString());  // dynamic
      formData.append("width", width.toString());    // dynamic
      ...
      formData.append("num_inference_steps", inferenceSteps.toString());  // dynamic
      formData.append("guidance_scale", guidanceScale.toString());        // dynamic
      formData.append("seed", '555');
      formData.append("repaint", "false");
      formData.append("concat_eval_results", "true");
      formData.append("cloth_type", "upper"); // You can make this dynamic if needed
    ...
    //   const client = await Client.connect("https://ad129e48f188d8e0f0.gradio.live/")
  ...
  return (
    <>
        <h1 className="text-center p-8 text-2xl font-bold md:text-3xl">Try on Room</h1>
